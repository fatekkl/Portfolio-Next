...
export default function Principal() {
  ...
  return (
    <main id="principal" className="flex relative">
      ...
      <section className="w-1/2 h-screen bg-jet flex flex-col">
        <div className="flex flex-col justify-center p-8 mt-10 relative">
          ...
          <p className="text-green_secondary text-lg md:text-xl font-semibold mb-6">Desenvolvedor Fullstack</p>
          ...
          <div className="flex space-x-4 mb-12">
            ...
            <a href="../MatheusCurriculo.pdf" download={true}>
      ...
      {/* Seção lateral */}
      <aside className="w-1/2 h-screen bg-green_secondary flex justify-center items-center">
